...
<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../images/caru1.jpg" class="d-block w-100" alt="Banner 1">
    </div>
    <div class="carousel-item">
      <img src="../images/FromPtoS.jpg" class="d-block w-100" alt="Banner 2">
    </div>
    <div class="carousel-item">
      <img src="../images/PI.jpg" class="d-block w-100" alt="Banner 3">
    </div>
  </div>
...
<section id="cant">
  ...
  <img src="../images/img1.jpg" class="card-img-top" alt="banner1">
  <div class="card-body">
    <h5 class="card-title">Process methodology.</h5>
    <p class="card-text">How the process to create requisitions works.</p>
    <a href="#" class="btn btn-primary">Go</a>
  </div>
  </div>

  <div class="card conte">
  <img src="../images/img2.jpg" class="card-img-top" alt="banner2">
  <div class="card-body">
    <h5 class="card-title">How CelorA was born.</h5>
    <p class="card-text">About how the idea of creating CelorA was born.</p>
    <a href="#" class="btn btn-primary">Go</a>
  </div>
  </div>
  ...
  <div class="card conte">
  <img src="../images/desarrollo.jpg" class="card-img-top" alt="banner3">
  <div class="card-body">
    <h5 class="card-title">About how the idea of creating CelorA was born.</h5>
    <p class="card-text">How the application was developed, how the work was managed and what ideas we took for our image.</p>
    <a href="#" class="btn btn-primary">Go</a>
  </div>
  </div>
