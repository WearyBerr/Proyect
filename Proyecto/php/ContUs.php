...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="../css/contus.css">
...
<div class="card contact-card">
  <div class="row g-0 align-items-center">
    <div class="col-md-5">
      <img src="../images/ftp.png" class="img-fluid rounded-start" alt="Contact Image">
    </div>
    <div class="col-md-7">
      <div class="card-body">
        <h5 class="card-title">Get in Touch</h5>
        <p class="card-text">Have questions? Reach out to us and we'll be happy to assist you. You can contact us via:</p>
        <ul class="contact-info">
          <li><strong>Email:</strong> support@celora.com</li>
          <li><strong>Phone:</strong> +1 800 123 4567</li>
          <li><strong>Address:</strong> Av 4 priv Anis int#18, Tijuana City</li>
        </ul>
        <p class="card-text"><strong>Office Hours:</strong> Mon-Fri, 9:00 AM - 5:00 PM</p>
      </div>
    </div>
  </div>
</div>
...
<div class="card email-card">
  <div class="row g-0 align-items-center">
    <div class="col-md-5">
      <img src="../images/email.png" class="img-fluid rounded-start" alt="Email Image">
    </div>
    <div class="col-md-7">
      <div class="card-body">
